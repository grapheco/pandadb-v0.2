...
public interface Write
{
     ...
     * @return The internal id of the created node
     */
    long nodeCreate(long nodeId);

    /**
     * Create a node with given id, and assign it the given array of labels.
     * <p>
     ...
     * @return The internal id of the created node.
     */
    long nodeCreateWithLabels( long nodeId, int[] labels ) throws ConstraintValidationException;
     ...
     * @return the internal id of the created relationship
     */
    long relationshipCreate( long sourceNode, int relationshipType, long targetNode , long relationshipId) throws EntityNotFoundException;
