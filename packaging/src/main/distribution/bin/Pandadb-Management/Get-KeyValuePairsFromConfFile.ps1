...
<#
.SYNOPSIS
Parses a Pandadb configuration file into a hashtable

.DESCRIPTION
Parses a Pandadb configuration file into a hashtable.  Multivalue keys are output as string[] types.

.PARAMETER Filename
The full path to the file to read

.EXAMPLE
Get-KeyValuePairsFromConfFile -Filename 'C:\Pandadb\conf\pandadb.conf'

Reads the file 'C:\Pandadb\conf\pandadb.conf' and outputs a hashtable of key/value pairs
