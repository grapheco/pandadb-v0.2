...
<#
.SYNOPSIS
Confirms whether the specificed java executable is suitable for Pandadb and checks if Java is Java 8
...
function Get-JavaVersion
{
  ...
  process {
    ...
    $javaHelpText = "* Please use Oracle(R) Java(TM) 8, OpenJDK(TM) or IBM J9 to run Pandadb Server.`n" +
    "* Please see https://pandadb.com/docs/ for Pandadb installation instructions."
    ...
    if ($javaVersion -lt '1.8') {
      Write-Warning "ERROR! Pandadb cannot be started using java version $($javaVersion)"
